    ...
    <div className="absolute inset-0 -z-10 h-full w-full bg-background overflow-hidden">
        <div className="relative h-full w-full bg-background">
            ...
            <div
                ...
                className="absolute top-[20%] left-[10%] h-72 w-72 bg-primary/20 opacity-50 blur-3xl animate-[morph_18s_ease-in-out_infinite] transition-transform duration-500 ease-out"
            ></div>
            <div
                style={{ transform: getTransform(-30), '--tx': '-80px', '--ty': '-120px' } as React.CSSProperties}
                className="absolute top-[50%] left-[60%] h-60 w-60 bg-accent/20 opacity-40 blur-3xl animate-[morph_22s_ease-in-out_infinite_4s] transition-transform duration-500 ease-out"
            ></div>
            <div
